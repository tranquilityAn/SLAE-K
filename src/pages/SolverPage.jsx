...
const SolverPage = () => {
    ...
    const [iterSettings, setIterSettings] = useState({
        epsExp: "-6",
        maxIter: "500",
    });
        ...
        <div className="stack">
            ...
            <div className="section-card">
                ...
                <p className="method-hint" style={{ marginBottom: 0 }}>
                    Switch between manual form inputs and loading a formatted
                    text file.
                </p>
            </div>
                ...
                >
                    <div>
                        ...
                        <p className="method-hint" style={{ margin: 0 }}>
                            Validate inputs, run the selected algorithm, and
                            verify the residual.
                        </p>
                    </div>
